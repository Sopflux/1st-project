...
public class Staff_listVO {
	...
	public String getSl_birth() {
		return sl_birth;
	}
	public void setSl_birth(String sl_birth) {
	...
	public Staff_listVO(int sl_no, String sl_name, String sl_birth, String sl_country, String sl_image) {
		super();
		this.sl_no = sl_no;
		this.sl_name = sl_name;
		this.sl_birth = sl_birth;
