...
public class RegisterFrame extends JFrame {
	...
	public RegisterFrame(LoginFrame lf) {
		...
		LineBorder lb = new LineBorder(Color.black);
		Color coc = new Color(238,241,255);
		Color cocc = new Color(57, 72, 103);
		...
		//변
		jtf_id.setBorder(lb);
		jtf_name.setBorder(lb);
		jtf_pw.setBorder(lb);
		jtf_pw2.setBorder(lb);
		jtf_email.setBorder(lb);
		jtf_nick.setBorder(lb);
		jtf_phone.setBorder(lb);
		//변경
		...
		//변
		p_id_sub.setBackground(co);
		p_phone.setBackground(co);
		p_nick.setBackground(co);
		p_nick_sub.setBackground(co);
		p_birth.setBackground(co);
		p_email.setBackground(co);
		p_pw2.setBackground(co);
		p_pw.setBackground(co);
		p_name.setBackground(co);
